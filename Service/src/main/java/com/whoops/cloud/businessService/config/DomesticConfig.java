package com.whoops.cloud.businessService.config;
...
@EnableJpaRepositories(
        basePackages = {"com.whoops.cloud.businessService.repository.domestic"},// 1. dao 层所在的包
...
public class DomesticConfig {
    ...
    public LocalContainerEntityManagerFactoryBean domesticEntityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.whoops.cloud.businessService.entity");// 2. 实体类所在的包
